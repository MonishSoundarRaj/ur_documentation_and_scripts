...
def main():
    ...
    pickup_pose = [x/1000, y/1000, 0.1710, rx, ry, rz]
    velocity = 0.1
    acceleration = 0.1

    print("\nMoving to pickup...")
    rtde_c.moveL(pickup_pose, velocity, acceleration)
    time.sleep(1)
    print("Pickup reached.")
    ...
    intermediate_pose = [x/1000, y/1000, 0.2363, rx, ry, rz]
    rtde_c.moveL(intermediate_pose, velocity, acceleration)
    time.sleep(1)
    print("intermediate pose reached.")

    print("\nMoving to target...")
    target_pose = [x1/1000, y1/1000, 0.1910, rx1, ry1, rz1]
